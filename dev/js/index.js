...
$(document).ready(function () {
  ...
  $('[newProductsSlider_js]').each(function () {
    ...
    function init() {
      var swiperEl = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : swiperEL;
  ...
  $('[productsSlider_js]').each(function () {
    ...
    var navigationNext = $(this).parents('.section-products-swiper').find('.swiper__navigation-btn-prev')[0];
